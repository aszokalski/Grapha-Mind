...
import { LinkingDraggingTool } from '../LinkingDraggingTool';
    ...
    $("ContextMenuButton",
      $(go.TextBlock, "Ważne"), {
        click: function (e, obj) {
          ...
          if(adorn instanceof go.Adornment){
            diagram.model.setDataProperty(adorn?.adornedPart?.data, 'stroke', 'red');
          }
    ...
    $("ContextMenuButton",
      $(go.TextBlock, "TODO"), {
        click: function (e, obj) {
          ...
          adorn?.diagram?.startTransaction("Subtree Layout");
          if(adorn instanceof go.Adornment){
            diagram.model.setDataProperty(adorn?.adornedPart?.data, 'stroke', 'orange');
          }
          adorn?.diagram?.commitTransaction("Subtree Layout");
        }
      }
    ...
    $("ContextMenuButton",
      $(go.TextBlock, "Zwykłe"), {
        click: function (e, obj) {
          ...
          adorn?.diagram?.startTransaction("Subtree Layout");
          if(adorn instanceof go.Adornment){
            diagram.model.setDataProperty(adorn?.adornedPart?.data, 'stroke', 'black');
          }
          adorn?.diagram?.commitTransaction("Subtree Layout");
        }
      }
